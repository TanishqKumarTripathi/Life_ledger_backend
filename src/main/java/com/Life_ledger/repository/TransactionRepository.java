...
""")
  ...
  @Query("""
      ...
      ORDER BY t.date DESC
      """)
  List<Transaction> findByMerchantAndAmountRange(@Param("userId") Long userId, @Param("merchant") String merchant,
      @Param("amount") BigDecimal amount, @Param("tolerance") BigDecimal tolerance);
  ...
  @Query("""
          ...
          ORDER BY t.date DESC
      """)
  List<Transaction> findByBankAccountAndMonth(Long bankAccountId, int month, int year);
